...
import online_quiz.models
import online_quiz.validators
import re
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', online_quiz.models.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='online_quiz.Category', verbose_name='Category')),
            ],
            options={
                'verbose_name': 'Quiz',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='online_quiz.Quiz', verbose_name='Quiz')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='online_quiz.Category', verbose_name='Category')),
                ('quiz', models.ManyToManyField(blank=True, to='online_quiz.Quiz', verbose_name='Quiz')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to=online_quiz.models.upload_csv_file, validators=[online_quiz.validators.csv_file_validator])),
